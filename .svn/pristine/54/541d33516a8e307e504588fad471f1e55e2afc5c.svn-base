========================================================================
    MICROSOFT 基础类库 : CompressorAlarm 项目概况
========================================================================


应用程序向导已为您创建了此 CompressorAlarm DLL。此 DLL 不仅
说明了使用 Microsoft 基础类的基础，而且
也是编写 DLL 的起点。

此文件包含组成 CompressorAlarm DLL
的每个文件的内容摘要。

CompressorAlarm.vcproj
...
CompressorAlarm.h
    这是 DLL 的主头文件。它声明了
    CCompressorAlarmApp 类。

CompressorAlarm.cpp
    这是主 DLL 源文件。它包含了类 CCompressorAlarmApp。
CompressorAlarm.rc
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 CompressorAlarm.pch
