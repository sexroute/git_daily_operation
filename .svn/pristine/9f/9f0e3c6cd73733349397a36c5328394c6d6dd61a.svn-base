...
#define DSE_DeletePointEx(pt)          { if(0 != (pt)) { delete (pt); (pt)= 0;} } 

#define WM_MSG_SHOW_LOG WM_USER+105
#define WM_MSG_DESTROY_WINDOW WM_USER+106
#define WM_MSG_SET_INIT_INF WM_USER+107
#include "KDCommlib.h"