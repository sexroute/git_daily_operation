...
{
	CImplement impl;
	return impl.ExpertSysGetRegAlarmFeatureExtract(pFixComm,pDB);
}
...
{
	CImplement impl;
	return impl.ExpertSysGetSpecChannFeatureExtract(pFixComm,pDB);
}
...
{
	CImplement impl;
	return impl.ExpertSysGetPlantFactName(pFixComm,pDB);
}