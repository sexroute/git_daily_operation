...
protected:
	...
	BOOL _AcquireReaderLockAndLeaveCS(long alTime_out = INFINITE) throw();
	void _ReleaseReaderLockAndLeaveCS() throw();
	BOOL _AcquireWriterLockAndLeaveCS(BOOL blMustWait,long alTime_out = INFINITE) throw();
...
public:
	...
	BOOL AcquireWriterLock(long alTime_out = INFINITE) throw();
	void ReleaseWriterLock() throw();
	BOOL AcquireReaderLock(long alTime_out = INFINITE) throw();
	void ReleaseReaderLock() throw();
	BOOL TryReleaseReaderAndAcquireWriterLock() throw();
...
typedef CAutoReadLockT<CReaderWriterLockNonReentrance> CAutoReadLockNonReentrance;
typedef CAutoWriteLockT<CReaderWriterLockNonReentrance> CAutoWriteLockNonReentrance;
