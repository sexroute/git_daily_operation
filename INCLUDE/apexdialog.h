#if !defined(AFX_APEXDIALOG_H__73972007_1F13_11D3_8029_00105A1FCFF5__INCLUDED_)
#define AFX_APEXDIALOG_H__73972007_1F13_11D3_8029_00105A1FCFF5__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// ApexDialog.h : header file
//
#include "dib256.h"
...
//class _declspec(dllexport) CApexDialog : public CDialog
class AFX_EXT_CLASS CApexDialog : public CDialog
{
// Construction
public:
	...
	BOOL SetBitmap(UINT uResource, int Type = CApexDialog::BITMAP_STRETCH);
	BOOL SetBitmap(UINT uResource, HMODULE hModule,int Type = CApexDialog::BITMAP_STRETCH);
	CApexDialog(UINT nIDTemplate,CWnd* pParent = NULL);   // standard constructor
    ~CApexDialog();
	static BOOL  CompareClassName(HWND hWnd, LPCTSTR lpszClassName);
// Dialog Data
	//{{AFX_DATA(CApexDialog)
...
#endif // !defined(AFX_APEXDIALOG_H__73972007_1F13_11D3_8029_00105A1FCFF5__INCLUDED_)
