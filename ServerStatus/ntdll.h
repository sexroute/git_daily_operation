...
typedef enum _ObjectTypeList
{
	...
	OB_TYPE_DEBUG_OBJECT         ,//=   9,  8,fixed
	OB_TYPE_INDEX_EVENT_PAIR     ,//=   10 , [Even] "EventPair"
	OB_TYPE_INDEX_MUTANT         ,//=   11 , [Muta] "Mutant"
	OB_TYPE_INDEX_CALLBACK       ,//=   12 , [Call] "Callback"
	OB_TYPE_INDEX_SEMAPHORE      ,//=   13 , [Sema] "Semaphore"
	OB_TYPE_INDEX_TIMER          ,//=   14 , [Time] "Timer"
	OB_TYPE_KEYED_EVENT,		  //=   15
	OB_TYPE_INDEX_PROFILE        ,//=   16 , [Prof] "Profile"
	OB_TYPE_INDEX_WINDOW_STATION ,//=   17 , [Wind] "WindowStation"
	OB_TYPE_INDEX_DESKTOP        ,//=   18 , [Desk] "Desktop"
	OB_TYPE_INDEX_SECTION        ,//=   19 , [Sect] "Section"
	OB_TYPE_INDEX_KEY            ,//=   20 , [Key ] "Key"
	OB_TYPE_INDEX_PORT           ,//= 	21 , [Port] "Port"
	OB_TYPE_INDEX_WAITABLE_PORT	 ,//=	22 , [Wait] "WaitablePort"
	OB_TYPE_INDEX_ADAPTER        ,//=   23 , [Adap] "Adapter"
	OB_TYPE_INDEX_CONTROLLER     ,//=   24 , [Cont] "Controller"
	OB_TYPE_INDEX_DEVICE         ,//=   25 , [Devi] "Device"
	OB_TYPE_INDEX_DRIVER         ,//=   26 , [Driv] "Driver"
	OB_TYPE_INDEX_IO_COMPLETION	 ,//=   27 , [IoCo] "IoCompletion"
	OB_TYPE_INDEX_FILE           ,//=   28 , [File] "File"
	OB_TYPE_INDEX_WMI_GUID    	 ,//=   29 , [WmiG] "WmiGuid"
};
