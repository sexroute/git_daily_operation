========================================================================
    MICROSOFT 基础类库 : DieselAlarmWC 项目概况
========================================================================


应用程序向导已为您创建了此 DieselAlarmWC DLL。此 DLL 不仅
说明了使用 Microsoft 基础类的基础，而且
也是编写 DLL 的起点。

此文件包含组成 DieselAlarmWC DLL
的每个文件的内容摘要。

DieselAlarmWC.vcproj
...
DieselAlarmWC.cpp
    这是主 DLL 源文件。它包含了类 CDieselAlarmWCApp。
DieselAlarmWC.rc
