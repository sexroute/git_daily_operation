...
IceProxy::BHAco::Request::RequestData(const ::BHAco::SDataPacket& dp, const ::Ice::Context* __ctx)
{
    ...
    while(true)
    {
        ...
        try
        {
            ...
            ::IceDelegate::BHAco::Request* __del = static_cast< ::IceDelegate::BHAco::Request*>(static_cast<void *>(__delBase.get()));
...
IceDelegateD::BHAco::Request::RequestData(const ::BHAco::SDataPacket& dp, const ::Ice::Context* __context)
{
    ...
    while(true)
    {
        ...
        try
        {
            ::BHAco::Request* __servant = (::BHAco::Request*)((void *)(__direct.servant().get()));
            if(!__servant)
            {
...
IceDelegateD::BHAco::Request::shutdown(const ::Ice::Context* __context)
{
    ...
    while(true)
    {
        ...
        try
        {
            ::BHAco::Request* __servant = static_cast< ::BHAco::Request*>(static_cast<void *>(__direct.servant().get()));
            if(!__servant)
            {
                ::Ice::OperationNotExistException __opEx(__FILE__, __LINE__);
                __opEx.id = __current.id;
